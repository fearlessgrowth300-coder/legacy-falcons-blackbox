...
static const char* blocked_files[] = {
    ...
    // Build-variant host data dirs (keep in sync with app/build.gradle productFlavors)
    "/data/data/top.niunaijun.blackbox",
    "/data/data/com.novspace.box",
    "/data/data/app.cloudvault.multi",
    "/data/data/io.prismhub.clone",
    "/blackbox",
    "/virtual",
