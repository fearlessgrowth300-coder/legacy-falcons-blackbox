...
public class IDeviceIdentifiersPolicyProxy extends BinderInvocationStub {
    ...
    public static class x extends MethodHook {
        ...
        protected Object hook(Object who, Method method, Object[] args) throws Throwable {
            // Per-clone serial. Without this, every clone on the same host package returned
            // md5(hostPkg) = an IDENTICAL Build.getSerial() across clones = account linkage.
            top.niunaijun.blackbox.core.DeviceProfile p = top.niunaijun.blackbox.core.DeviceProfile.CURRENT;
            if (p != null && p.serial != null) {
                return p.serial;
            }
